...
parser.add_argument('-opt', type=str, help='Path to options YMAL file.', default="config/test/test_lesrcnn_x3.yml")
...
paddle.save(ckpt_pd, 'trans_weights/trans_x3.pdparams')
a = 1